...
public class FedexCreateLabelRequest
{    /// <summary>
...
public class Dimensions
{
    ...
    /// <summary>
    /// Indicate the width of the package. No implied decimal places. Maximum value: 999shippingchargespaymetn
    /// </summary>
    [JsonProperty("width")]
...
public class RequestedShipment
{
    ...
    public ShippingChargesPaymentDto? ShippingChargesPayment { get; set; }
    /// <summary>
...
public class ShippingChargesPaymentDto
{
    /// <summary>
